...
public class Name {
    ...
    private static final String MESSAGE_NAME_CONSTRAINTS = "Person names should be spaces or alphabetic characters";
    private static final String NAME_VALIDATION_REGEX = "[\\p{Alpha} ]+";
